...
MIDDLEWARE_CLASSES = (
    'commons.middleware.RequestTransactionIDMiddleware',
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '%(asctime)s %(levelname)s [%(transaction_id)s] %(module)s %(funcName)s %(message)s'
        },
        'simple': {
...
# To provide user authentication against TDA
AUTHENTICATION_BACKENDS = ('commons.authentication.backends.TdaBackend',)

# Do not leave django append slash if a url don't provide slash at the end
# Redirect when put methods become a GET
APPEND_SLASH = False

# transaction id header for logging
REQUEST_TRANSACTION_ID_HEADER = 'HTTP_X_TRANSACTION_ID'
